...
# Exclusions live in scripts/build_workspace.sh, shared with ci.yml and
# release.yml so all three stay in sync.
build: ## Build every deployable contract for wasm32v1-none
